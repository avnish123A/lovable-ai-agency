...
import { RoundedBox, Text, Float, MeshDistortMaterial, Sphere } from "@react-three/drei";
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-6xl lg:text-7xl font-heading font-extrabold text-foreground mb-6 tracking-tight"
        >
          Something{" "}
        ...
        >
          We're building the future of financial comparison. Be the first to know.
        </motion.p>
        ...
        <motion.div
          ...
          className="grid grid-cols-4 gap-3 sm:gap-5 max-w-lg mx-auto mb-12"
        >
          {[
        ...
        >
          ...
          <Button
            type="submit"
            disabled={loading}
            className="h-14 px-8 rounded-xl bg-gradient-cta text-white font-bold btn-glow shadow-glow-sm"
          >

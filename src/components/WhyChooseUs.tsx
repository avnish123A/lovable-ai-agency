...
const WhyChooseUs = () => (
  <section className="py-32 relative overflow-hidden">
    <motion.div 
      ...
      className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary/3 rounded-full blur-3xl" 
    />
    <motion.div 
      animate={{ x: [0, -20, 0], y: [0, 30, 0], scale: [1, 1.15, 1] }}
      transition={{ duration: 18, repeat: Infinity, ease: "easeInOut", delay: 3 }}
      className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-accent/3 rounded-full blur-3xl" 
    />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-heading font-extrabold mb-8 text-foreground leading-tight tracking-tight">
            Trusted Financial{" "}
            <span className="text-gradient text-glow">Information</span> Platform
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {reasons.map((r, i) => (
            <motion.div
              ...
              className="p-7 rounded-3xl glass-card-hover relative overflow-hidden group"
            >
              <div className="relative z-10">
                <motion.div 
                  whileHover={{ rotate: [0, -10, 10, 0], transition: { duration: 0.5 } }}
                  className="w-14 h-14 rounded-2xl bg-gradient-cta flex items-center justify-center mb-5 shadow-neon"
                >

...
const HeroSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden">
      ...
      <motion.div style={{ y: bgY }} className="absolute inset-0 grid-pattern opacity-30" />
          ...
          <div className="max-w-2xl">
            ...
            >
              {stats.map((stat, i) => (
                ...
                >
                  <div className="w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center glow-pulse">
              ...
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Button asChild variant="outline" size="lg" className="text-base px-10 h-16 border-2 border-border hover:bg-secondary hover:border-primary/30 rounded-2xl font-bold text-foreground group">
                  <Link to="/loans" className="flex items-center">
                    <Play className="w-5 h-5 mr-2.5 text-accent group-hover:scale-125 transition-transform duration-300" />
                    Compare Loans
                  </Link>
                </Button>
              </motion.div>
          ...
          >
            <div className="relative">
              <motion.div 
                ...
                className="absolute inset-0 bg-gradient-to-br from-primary/20 to-accent/20 rounded-3xl blur-3xl scale-110" 
              />
              <Card3DErrorBoundary>
                <Suspense fallback={
                  <div className="relative w-full h-[500px] flex items-center justify-center">
                    <motion.div 
                      ...
                      className="w-80 h-48 rounded-3xl bg-gradient-to-br from-primary/20 to-accent/10"
                    />
                  </div>
                }>
                  <CreditCard3D />

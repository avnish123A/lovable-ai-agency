      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Find the right financial products using smart tools and AI recommendations. 
            ...
            >
              <Button asChild size="lg" className="bg-gradient-cta text-primary-foreground hover:opacity-90 text-base px-8 shadow-glow rounded-xl font-semibold btn-glow">
                <Link to="/credit-cards">
                  Explore Credit Cards <ArrowRight className="ml-2 w-4 h-4" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="text-base px-8 border-primary/20 hover:bg-primary/5 hover:border-primary/40 rounded-xl font-semibold text-foreground">

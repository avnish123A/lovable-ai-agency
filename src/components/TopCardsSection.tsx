        ...
        >
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-3 text-foreground tracking-tight">
              Top Credit <span className="text-primary">Cards</span>
            </h2>
          ...
          <Link
            to="/credit-cards"
            className="btn-secondary mt-4 md:mt-0 px-6 py-2.5 text-sm inline-block text-center"
          >
            View All Cards
          </Link>
        </motion.div>
            ...
            >
              <div className="flex items-center justify-between px-6 pt-5 pb-2">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-xs font-medium text-foreground">{card.bank_name}</span>
                </div>
              ...
              <div className="px-6 pb-6">
                <h3 className="font-semibold text-foreground text-sm mb-3">{card.card_name}</h3>
                <div className="space-y-2.5 mb-4">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-foreground font-bold">{fmt(card.annual_fee)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-muted-foreground">Cashback</span>
                    <span className="text-primary font-bold">{card.cashback_rate || "—"}</span>
                  </div>
                </div>
